    ...
    public partial class NewVendor : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                SqlCommand insertCommand = new SqlCommand("insert into Vendors(Name,Email,Phone,Website,Address,IID,Image,FileName) values(@IName,@IEmail,@IPhone,@IWebsite,@IAddress,@Iid,@Image,@IPath)");
        ...
        private void PictureBrowse_Click(object sender, EventArgs e)
        {
            OpenFileDialog opnfd = new OpenFileDialog();
            opnfd.Filter = "Image Files (*.jpg;*.jpeg;.*.gif;)|*.jpg;*.jpeg;.*.gif";
            if (opnfd.ShowDialog() == DialogResult.OK)
